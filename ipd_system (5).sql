...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2022 at 08:21 PM
...
(2, 'KEPI01', '10.000', 'Test', '2.00', 'GOOD', '', '0.000', '1122334-01', 'QR01', 'LOT01', 'GOOD', 'sys-admin', '2022-07-18 22:07:39'),
(3, 'KEPI01', '10.000', 'Test', '2.00', 'GOOD', '', '0.000', '1122334-01', 'QR03', 'LOT03', 'GOOD', 'sys-admin', '2022-07-18 22:07:07'),
(4, 'KEPI01', '10.000', 'Test', '2.00', 'GOOD', '', '0.000', '1122334-01', 'QR02', 'LOT02', 'NG', 'sys-admin', '2022-07-18 22:07:25'),
(5, 'KEPI01', '10.000', 'Test', '2.00', 'GOOD', '', '0.000', '1122334-01', 'QR04', 'LOT04', 'NG', 'sys-admin', '2022-07-18 22:07:35'),
(6, 'KEPI01', '10.000', 'Test', '2.00', 'GOOD', '', '0.000', '1122334-01', 'QR05', 'LOT05', 'NG', 'sys-admin', '2022-07-18 22:07:42'),
(7, 'KEPI01', '10.000', 'Test', '2.00', 'GOOD', '', '0.000', '1122334-01', 'QR06', 'LOT06', 'NG', 'sys-admin', '2022-07-18 22:07:47'),
(8, 'KEPI02', '30.000', 'Test', '2.00', 'NG', 'Test', '10.000', '2233441-02', 'QR08', 'LOT08', 'NG', 'sys-admin', '2022-07-18 22:07:20');
...
(1, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR01', 'LOT01', 'GOOD', 'sys-admin', '2022-07-18 22:07:53'),
(2, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR02', 'LOT02', 'GOOD', 'sys-admin', '2022-07-18 22:07:02'),
(3, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR03', 'LOT03', 'GOOD', 'sys-admin', '2022-07-18 22:07:12'),
(4, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR04', 'LOT04', 'GOOD', 'sys-admin', '2022-07-18 22:07:20'),
(5, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR05', 'LOT05', 'GOOD', 'sys-admin', '2022-07-18 22:07:27'),
(6, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR06', 'LOT06', 'GOOD', 'sys-admin', '2022-07-18 22:07:31'),
(7, 'KEPI01', 'Test', '2.00', NULL, 'GOOD', '30.000', NULL, '0.000', '1122334-01', 'QR07', 'LOT07', 'GOOD', 'sys-admin', '2022-07-18 22:07:36');
...
INSERT INTO `t_handwork_process` (`id`, `assy_code`, `kepi_lot`, `hw_line`, `hw_shift`, `createdby`, `createdon`) VALUES
(1, '1122334-01', 'KEPI01', '1', 'B', 'sys-admin', '2022-07-18 22:07:06'),
(2, '2233441-02', 'KEPI02', '2', 'B', 'sys-admin', '2022-07-18 22:07:39');

-- --------------------------------------------------------

--
-- Table structure for table `t_handwork_process_items`
--

CREATE TABLE `t_handwork_process_items` (
  ...
  `ft_process` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT 'N',
  `createdby` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `createdon` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `t_handwork_process_items`
--

INSERT INTO `t_handwork_process_items` (`kepi_lot`, `assy_code`, `barcode_serial`, `part_lot`, `ageing_process`, `ft_process`, `createdby`, `createdon`) VALUES
('KEPI01', '1122334-01', 'QR01', 'LOT01', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR02', 'LOT02', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR03', 'LOT03', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR04', 'LOT04', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR05', 'LOT05', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR06', 'LOT06', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI02', '2233441-02', 'QR08', 'LOT08', 'Y', 'N', 'sys-admin', '2022-07-18');
...
INSERT INTO `t_smt_line_process` (`id`, `assy_code`, `kepi_lot`, `smt_line`, `smt_shift`, `createdby`, `createdon`) VALUES
(1, '1122334-01', 'KEPI01', '1', 'A', 'sys-admin', '2022-07-18 21:07:34'),
(3, '2233441-02', 'KEPI02', '1', 'A', 'sys-admin', '2022-07-18 22:07:40');

-- --------------------------------------------------------

--
-- Table structure for table `t_smt_line_process_items`
--

CREATE TABLE `t_smt_line_process_items` (
  `kepi_lot` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `assy_code` varchar(70) COLLATE utf8mb4_unicode_ci NOT NULL,
  `barcode_serial` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `part_lot` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
-- Dumping data for table `t_smt_line_process_items`
--

INSERT INTO `t_smt_line_process_items` (`kepi_lot`, `assy_code`, `barcode_serial`, `part_lot`, `ageing_process`, `ft_process`, `createdby`, `createdon`) VALUES
('KEPI01', '1122334-01', 'QR01', 'LOT01', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR02', 'LOT02', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR03', 'LOT03', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR04', 'LOT04', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR05', 'LOT05', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR06', 'LOT06', 'Y', 'Y', 'sys-admin', '2022-07-18'),
('KEPI01', '1122334-01', 'QR07', 'LOT07', 'N', 'Y', 'sys-admin', '2022-07-18'),
('KEPI02', '2233441-02', 'QR08', 'LOT08', 'Y', 'N', 'sys-admin', '2022-07-18');
...
(1, 'QR01', '209080001', 'LOT01', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(2, 'QR02', '2177530-00', 'LOT02', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(3, 'QR03', '2180504-00', 'LOT03', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(4, 'QR04', '2180281-00', 'LOT04', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(5, 'QR05', '2180439-00', 'LOT05', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(6, 'QR06', '209080002', 'LOT06', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(7, 'QR07', '2180505-00', 'LOT07', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18'),
(8, 'QR08', '209080001', 'LOT08', '0.000', NULL, NULL, 'PENDING', 'PENDING', '2022-07-18', 'sys-admin', '2022-07-18');

-- --------------------------------------------------------

--
-- Stand-in structure for view `v_ageing_ft_data`
-- (See below for the actual view)
--
CREATE TABLE `v_ageing_ft_data` (
`kepi_lot` varchar(50)
...
--
-- Stand-in structure for view `v_critical_parts`
-- (See below for the actual view)
--
CREATE TABLE `v_critical_parts` (
`smt_date` date
,`assy_code` varchar(70)
,`model` varchar(100)
,`kepi_lot` varchar(50)
...
--
-- Stand-in structure for view `v_critical_parts_report`
-- (See below for the actual view)
--
CREATE TABLE `v_critical_parts_report` (
`smt_date` date
,`assy_code` varchar(70)
,`model` varchar(100)
,`kepi_lot` varchar(50)
...
--
-- Stand-in structure for view `v_handwork_process`
-- (See below for the actual view)
--
CREATE TABLE `v_handwork_process` (
`assy_code` varchar(70)
,`kepi_lot` varchar(50)
,`hw_line` varchar(50)
,`hw_shift` varchar(50)
,`barcode_serial` varchar(50)
,`part_lot` varchar(50)
,`ageing_process` varchar(1)
,`ft_process` varchar(1)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `v_header_ageing`
-- (See below for the actual view)
--
CREATE TABLE `v_header_ageing` (
`kepi_lot` varchar(50)
,`assy_code` varchar(70)
,`quantity` decimal(15,3)
,`ageing_time` decimal(10,2)
...
--
-- Stand-in structure for view `v_header_ft`
-- (See below for the actual view)
--
CREATE TABLE `v_header_ft` (
`kepi_lot` varchar(50)
,`assy_code` varchar(70)
,`ft_quantity` decimal(15,3)
,`ft_result` varchar(100)
,`failure_remark` text
...
--
-- Stand-in structure for view `v_part_d1`
-- (See below for the actual view)
--
CREATE TABLE `v_part_d1` (
`kepi_lot` varchar(50)
,`D1` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_part_d2`
-- (See below for the actual view)
--
CREATE TABLE `v_part_d2` (
`kepi_lot` varchar(50)
,`D2` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_part_db1`
-- (See below for the actual view)
--
CREATE TABLE `v_part_db1` (
`kepi_lot` varchar(50)
,`DB1` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_part_ic1`
-- (See below for the actual view)
--
CREATE TABLE `v_part_ic1` (
`kepi_lot` varchar(50)
,`IC1` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_part_pc1`
-- (See below for the actual view)
--
CREATE TABLE `v_part_pc1` (
`kepi_lot` varchar(50)
,`PC1` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_part_qf1`
-- (See below for the actual view)
--
CREATE TABLE `v_part_qf1` (
`kepi_lot` varchar(50)
,`QF1` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_part_t1`
-- (See below for the actual view)
--
CREATE TABLE `v_part_t1` (
`kepi_lot` varchar(50)
,`T1` varchar(50)
,`part_lot_ageing_result` varchar(50)
,`part_lot_ft_result` varchar(50)
...
--
-- Stand-in structure for view `v_smt_process`
-- (See below for the actual view)
--
CREATE TABLE `v_smt_process` (
`assy_code` varchar(70)
,`kepi_lot` varchar(50)
,`smt_line` varchar(50)
,`smt_shift` varchar(50)
...
--
-- Stand-in structure for view `v_tes1`
-- (See below for the actual view)
--
CREATE TABLE `v_tes1` (
`kepi_lot` varchar(50)
...
--
-- Stand-in structure for view `v_tes2`
-- (See below for the actual view)
--
CREATE TABLE `v_tes2` (
`kepi_lot` varchar(50)
...
--
-- Structure for view `v_ageing_ft_data`
--
...
--
-- Structure for view `v_critical_parts`
--
...
--
-- Structure for view `v_critical_parts_report`
--
...
--
-- Structure for view `v_handwork_process`
--
...
--
-- Structure for view `v_header_ageing`
--
...
--
-- Structure for view `v_header_ft`
--
...
--
-- Structure for view `v_smt_process`
--
...
--
-- Indexes for table `t_handwork_process_items`
--
ALTER TABLE `t_handwork_process_items`
  ADD PRIMARY KEY (`kepi_lot`,`assy_code`,`barcode_serial`,`part_lot`);
...
--
-- Indexes for table `t_smt_line_process_items`
--
ALTER TABLE `t_smt_line_process_items`
  ADD PRIMARY KEY (`kepi_lot`,`assy_code`,`barcode_serial`,`part_lot`);
...
--
ALTER TABLE `t_warehouse_issuance`
  MODIFY `issuance_number` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
