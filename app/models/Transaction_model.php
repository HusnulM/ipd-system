...
class Transaction_model{
    ...
    public function getDataBySerial($serialno){
        $this->db->query("SELECT * FROM t_ipd_forms where serial_no='$serialno'");
    ...
    public function getProcessSequence(){
        $user = $_SESSION['usr']['user'];
        $this->db->query("SELECT * FROM t_process_sequence where username='$user'");
		return $this->db->single();
    }
    ...
    public function saveprocess($data){
        $processSequence = $this->getProcessSequence();
    ...
    public function createRepairForm(){
