...
class Handworkprocess_model{
    ...
    public function save($data){
        $query = "INSERT INTO t_handwork_process (assy_code, kepi_lot, barcode_serial, part_lot, hw_line, hw_shift, createdby, createdon) VALUES (:assy_code, :kepi_lot, :barcode_serial, :part_lot, :hw_line, :hw_shift, :createdby, :createdon)";
        $this->db->query($query);
