    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <form action="<?= BASEURL; ?>/master/saveaction" method="POST">
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" name="actionname" id="actionname" class="form-control" placeholder="Action Name" required="true">
                                    </div>
                                </div>
                            </div>
                        </div>
