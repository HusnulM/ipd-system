                                    ...
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="barcode" class="form-control" placeholder="Barcode Serial" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="partnumber" class="form-control" placeholder="Part Number" required="true">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="partlot" class="form-control" placeholder="Part Lot Number" required="true">
                                            </div>
                                        </div>
                                    </div>
                                </div>
