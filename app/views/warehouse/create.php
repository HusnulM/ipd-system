<section class="content">
        <div class="row clearfix">
            ...
            <form action="<?= BASEURL; ?>/warehouse/save" method="POST">
                <div class="card">
                    <div class="header">
                        <h2>
                            <?= $data['menu']; ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="whscode" id="whscode" class="form-control" placeholder="Kode Warehouse" required="true">
                                        </div>
                                    </div>
                                </div>                                
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="deskripsi" id="deskripsi" class="form-control" placeholder="Nama Warehouse">
                                        </div>
                                    </div>
                                </div>
                        </div>
